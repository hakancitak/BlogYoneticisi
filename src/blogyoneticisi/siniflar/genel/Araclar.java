...
package blogyoneticisi.siniflar.genel;
...
public class Araclar {
    ...
    public static String tarihZamnGoster(Timestamp ts){
    ...
    public static TableModel tabloIcinModelOlustur(Object[] baslik ,Object[][] veri){
        TableModel sonuc=new DefaultTableModel(veri, baslik){
   ...
   public static int soruSor(String soruIcerik){
       ...
       int n=JOptionPane.showOptionDialog(new JFrame(), soruIcerik, "?", 
               JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE, null, secenekler, secenekler[1]);
       return n;
   }
